...
namespace Animal.Migrations
{
    ...
    [Migration("20200128111603_AiModified")]
    partial class AiModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Animal.Models.GoatBreed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("dbug_goatBreed");
                });

            modelBuilder.Entity("Animal.Models.GoatRegistration", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("AverageWtFemale");

                    b.Property<decimal>("AverageWtMale");

                    b.Property<int>("DurationForWt");

                    b.Property<decimal>("FeedingExpense");

                    b.Property<string>("FeedingNature");

                    b.Property<decimal>("FertilizerPrice");

                    b.Property<decimal>("FertilizerWt");

                    b.Property<decimal>("FirstPregnancyTime");

                    b.Property<int?>("GoatBreedId");

                    b.Property<decimal>("GrowthRateWt");

                    b.Property<string>("MainPurpose");

                    b.Property<string>("MarketPlace");

                    b.Property<decimal>("MscExpense");

                    b.Property<int>("NoOfBaby");

                    b.Property<string>("OriginOf");

                    b.Property<decimal>("PasminaPrice");

                    b.Property<decimal>("PasminaProduction");

                    b.Property<decimal>("PregnancyDuration");

                    b.Property<decimal>("PricePerKg");

                    b.Property<decimal>("PricePerKgDam");

                    b.Property<decimal>("PurchasePerKg");

                    b.Property<string>("Siration");
                    ...
                    b.Property<decimal>("WeightOnBirth");

                    b.Property<string>("earTagNo");

                    b.HasKey("id");

                    b.HasIndex("GoatBreedId");
            ...
            modelBuilder.Entity("Animal.Models.keeper", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Animal.Models.lab", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Animal.Models.Lrp", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("munipalicity");

                    b.Property<string>("provience");

                    b.HasKey("id");

                    b.ToTable("dbug_lrpUser");
                });
            ...
            modelBuilder.Entity("Animal.Models.ViewModel.LrpVM", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Animal.Models.Ai", b =>
                {
                    b.HasOne("Animal.Models.AnimalRegistration", "Animal")
                        .WithMany()
                        .HasForeignKey("AnimalId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Animal.Models.AnimalRegistration", "Bull")
                        .WithMany()
            ...
            modelBuilder.Entity("Animal.Models.GoatRegistration", b =>
                {
                    b.HasOne("Animal.Models.GoatBreed", "GoatBreed")
                        .WithMany("Goats")
                        .HasForeignKey("GoatBreedId");
                });
