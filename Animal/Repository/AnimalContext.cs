...
namespace Animal.Repository
{
    public class AnimalContext: DbContext
    {
        ...
        public DbSet<Lrp> lrps { get; set; }
        public DbSet<Animal.Models.ViewModel.LrpVM> LrpVM { get; set; }
        public DbSet<Animal.Models.GoatBreed> GoatBreed { get; set; }
        public DbSet<Animal.Models.GoatRegistration> GoatRegistration { get; set; }
