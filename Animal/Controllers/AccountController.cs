...
namespace Animal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserRepository user, IConfiguration config, IAuthRepository auth)
        {
            _user = user;
            _config = config;
            _auth = auth;
      ...
      //  [Authorize]
        ...
        public IActionResult Login(string username, string password)
        {
            ...
            return RedirectToAction("Index", "AnimalRegistration");
        ...
        public IActionResult SeedData()
        {
            ...
            if (_user.GetByName("superadmin2") == null)
            {
                User user = new User();
                user.UserName = "superadmin2";
                user.Email = "spadmin2@email.com";
                ...
                var createdUser = _user.Register(user, "admin");
            }
            if (_user.GetByName("admin") == null)
            {
                User user = new User();
                user.UserName = "admin";
            ...
            if (_user.GetByName("lrp") == null)
            {
                User user = new User();
                user.UserName = "lrp";
                user.Email = "lrp@email.com";
                user.Role = "LRP";
                user.permission = true;
                if (_user.UserExists(user.UserName))
                {
            ...
            if (_user.GetByName("farm") == null)
            {
                User user = new User();
                user.UserName = "farm";
                user.Email = "farm@email.com";
                user.Role = "Farm";
                user.permission = user.permission;
                if (_user.UserExists(user.UserName))
                {
